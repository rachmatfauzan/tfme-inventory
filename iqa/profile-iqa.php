...
<head>
    ...
    <!-- Link CSS -->
    <link rel="stylesheet" href="../head/css/dashboard-hd.css">
    <link rel="stylesheet" href="../head/css/profile-hd.css">
                ...
                <form>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-2">
                            ...
                            <input type="text" class="form-control" style="text-transform: capitalize;"
                                value="<?= $result['handphone']; ?>" disabled>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <label>Address</label>
                            <textarea style="height: 7rem;" class="form-control"
                                disabled><?= $result['address']; ?></textarea>
                        </div>
                    </div>
                </form>
            </div>
