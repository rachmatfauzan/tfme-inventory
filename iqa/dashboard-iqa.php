...
<body>
    ...
    <div class="grid">
        ...
        <nav class="nav flex-column navbar-expand-lg bg-dark">
            ...
            <hr>
            <div class="nav-item">
                <a class="nav-link active" href="dashboard-iqa.html"><i class="fas fa-box-open"></i>Input & Update</a>
        ...
        <div class="konten">
            ...
            <?php 
                if (isset($_POST['input'])){
                    ...
                    setTimeout(function(){window.top.location="dashboard-iqa"},3000);
                    </script>';
                    exit;
                    }
            ...
            <?php  
                ...
                if (isset($_POST['ubah'])){
                    ...
                    setTimeout(function(){window.top.location="dashboard-iqa"},1500);
                    </script>';
                    exit;
                    }
                    else{
            ...
            <div class="box">
                ...
                <div class="title mb-4 text-uppercase d-flex justify-content-center">
                    <h5 class="font-weight-bold text-secondary" id="top"><i class="fas fa-box-open mr-3"></i>Data
                        Inventory
                    </h5>
                    <a type="button" data-toggle="modal" data-target=".glossary"
                        style="font-size:13px; opacity:0.6; cursor:pointer;"><i
                ...
                <div class="table-responsive mt-2">
                    ...
                    <table class="table table-striped" id="data">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a class="bg-success text-white" id="updateData" type="button"
                                        ...
                                        data-type="<?= $data['type']; ?>" data-supplier="<?= $data['supplier']; ?>"
                                        data-part_number="<?= $data['part_number']; ?>"
                                        ...
                                        data-batch_no="<?= $data['batch_no']; ?>" data-iqa="<?= $data['iqa']; ?>"
                                        ...
                                        data-pr_date="<?= $data['pr_date']; ?>">Update</a> ||
                                </td>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-box-open mr-3"></i>Edit
                                    Data
                                    Item</h5>
                            </div>
            ...
            <!-- scrool go top -->
            <a id="back-to-top" href="#" class="btn btn-light btn-lg back-to-top bg-success" role="button"><i
