    ...
    <div class="grid">
        ...
        <nav class="nav flex-column navbar-expand-lg bg-dark">
            ...
            <div class="nav-item">
                ...
                <a class="nav-link active" href="history-po"><i class="fas fa-truck-moving"></i>History PO</a>
        ...
        <div class="konten">
            ...
            <div class="kepala d-flex justify-content-between align-items-center mt-2 ml-2">
                <h5 class="mt-2 iqa"><i class="fas fa-file-invoice-dollar mr-2"></i>History PO Release<span
